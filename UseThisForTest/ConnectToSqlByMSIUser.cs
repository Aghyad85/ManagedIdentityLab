...
{
    public static class ConnectToSqlByMSIUser
    {
        [FunctionName("ConnectToSqlByMSIUser")]
            ...
            ILogger log)
        {
            ...
            try
            {
                ...
                AzureServiceTokenProvider tokenProvider = new AzureServiceTokenProvider($"RunAs=App;AppId={AppID}");
